...
func enrichC2(_ sdk.Exploit, opts []sdk.Option) []sdk.Option {
	...
	return append(opts,
		...
		sdk.OptString("TUNNEL", "", "Tunnel URL for staging (ngrok, bore, cloudflared)"),
		sdk.OptString("REMOTE_PATH", "", "Remote drop path (default: random /tmp)"),
		sdk.OptInt("WAITSESSION", 30, "Session wait timeout in seconds"),
		sdk.OptString("ARCH", "amd64", "Target architecture"),
		sdk.OptEnum("FETCH_COMMAND", "curl", "Staging download method", "curl", "wget", "python", "perl", "php", "certutil", "powershell", "tcp"),
	)
}
...
func enrichScan(_ sdk.Exploit, opts []sdk.Option) []sdk.Option {
	return append(opts, sdk.OptInt("THREADS", 10, "Scan threads"))
}
